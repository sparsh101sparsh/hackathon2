...
# Test execution with Piston Engine
...
export const MonacoPreviewDemo: React.FC = () => {
  ...
  const handleRun = () => {
    ...
    setTimeout(() => {
      ...
      setVerdict('ACCEPTED — 4ms • 14.2 MB (Piston Engine)');
    }, 800);
  };
    ...
    <section className="py-12 px-6 max-w-6xl mx-auto">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl sm:text-4xl font-extrabold text-white tracking-tight">
          Multi-Language Monaco Editor & AI Code Audit
        </h2>
        <p className="text-sm sm:text-base text-slate-400 max-w-2xl mx-auto mt-2">
          Experience real-time code execution with Piston API and instant deep-dive AI complexity analysis.
        </p>
      </div>

      {/* Editor & AI Card Container */}
      <motion.div
      ...
      >
        ...
        <div className="px-5 py-3.5 bg-slate-900/90 border-b border-slate-800 flex flex-wrap items-center justify-between gap-3">
          ...
          {/* Toggle Code / AI Review Modal Preview */}
          <div className="flex items-center gap-2">
            <div className="flex bg-slate-950 p-1 rounded-lg border border-slate-800 text-xs font-semibold">
              ...
              >
                ...
                <span>AI Code Review Modal</span>
              </button>
            </div>
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-bold text-xs shadow-md shadow-emerald-950/50 flex items-center gap-1.5 transition"
            >
              {isExecuting ? (
        ...
        <div className="p-6 relative min-h-[300px]">
          <AnimatePresence mode="wait">
            {activeTab === 'code' ? (
              ...
              >
                ...
                {verdict && (
                  ...
                  >
                    ...
                    <span className="text-[10px] text-emerald-400/80 font-mono">Piston v3.2.0</span>
                  </motion.div>
                )}
              </motion.div>
            ) : (
              ...
              >
                {/* AI Review Header */}
                <div className="flex items-center justify-between p-4 rounded-xl bg-purple-950/40 border border-purple-800/50">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 rounded-xl bg-purple-900/60 text-purple-300 border border-purple-700/60">
                      <Sparkles className="w-5 h-5" />
                    </div>
                    <div>
                      <h4 className="text-sm font-bold text-white">AI Code Review Report</h4>
                      <p className="text-xs text-purple-300">Generated by FreeModel Assistant</p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-1">
                    ...
                    <div className="text-xl font-bold font-mono text-cyan-300">O(N)</div>
                ...
                <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800 space-y-2">
                  ...
                  <p className="text-xs text-slate-300 leading-relaxed">
                    Great choice using a hash map to achieve <code className="text-cyan-400 font-mono">O(N)</code> time complexity instead of brute force <code className="text-rose-400 font-mono">O(N²)</code> nested loops!
                  </p>
                </div>
              </motion.div>
            )}
