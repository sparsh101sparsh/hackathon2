        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              Today&apos;s AI Recommended DSA Practice
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="px-2 py-0.5 text-[10px] font-medium rounded bg-cyan-950 text-cyan-300 border border-cyan-800/60 flex items-center gap-1">
                    <Target className="w-3 h-3" />
                    <span>{item.targetSkill}</span>
                  </span>
                </div>

                <h4 className="text-sm font-bold text-white group-hover:text-cyan-400 transition leading-snug">
                  {item.title}
                </h4>
              ...
              <Link
                ...
                className="inline-flex items-center justify-between w-full px-3 py-2 bg-slate-900 hover:bg-slate-800 text-cyan-400 text-xs font-semibold rounded-lg border border-slate-800 transition"
              >
...
export default DailyRecommendationsWidget;
