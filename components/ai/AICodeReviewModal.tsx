          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-20 gap-3">
              ...
              <span className="text-sm text-slate-300 font-medium animate-pulse">
                Analyzing time complexity, edge cases, and code quality with gpt-5.6-sol...
              </span>
            </div>
          ) : error ? (
            <div className="p-6 bg-rose-950/30 border border-rose-900/50 rounded-xl text-center space-y-3">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-300 uppercase tracking-wider">
                      AI Refactored & Clean Version ({language})
                    </span>
                    <button
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 font-mono text-xs">
                    ...
                    <div>
                      <div className="text-[11px] font-sans font-semibold text-emerald-400 mb-1.5 flex items-center justify-between">
                        <span>AI Refactored Solution</span>
