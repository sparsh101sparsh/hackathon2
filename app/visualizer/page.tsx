...
export default function VisualizerLibraryPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-200 px-4 sm:px-6 lg:px-8 py-8 font-mono">
      <div className="max-w-[1500px] mx-auto">
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-5 mb-8">
          <div>
            <div className="retro-label mb-3"><span>$ visualizer --catalog=75</span></div>
            <h1 className="font-mono text-3xl sm:text-5xl font-medium tracking-normal phosphor-glow">Watch the algorithm think<span className="text-cyan-400">_</span></h1>
