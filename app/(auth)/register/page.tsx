...
import { Code2, Mail, Lock, User as UserIcon, AlertCircle, Loader2, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 border border-slate-800 rounded-2xl p-8 shadow-2xl backdrop-blur-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight pt-2">Create Account</h1>
          <p className="text-xs text-slate-400">Join CodeForge AI to unlock full platform capabilities</p>
        </div>
