...
- Current Context: Problem "${problemTitle}", Language "${language}".`;
...
Statement Summary: ${problemStatement.slice(0, 300)}...
...
\`\`\``,
    ...
    let fallbackReply = `Great question! When tackling ${problemTitle}, think about your current data structures and algorithm steps. `;
